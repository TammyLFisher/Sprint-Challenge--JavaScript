...
// tyrannosaurus.prototype= Object.create({});

tyrannosaurus.greet = function() {
...
graduates.forEach(function(graduates) {
  ...
  let chosenUniversity=graduates.university;
  universities.push(chosenUniversity);
});
...
graduates.forEach(function(graduates) {
  console.log(graduates);
  let currentContactInfo=graduates.first_name + " " + graduates.email;
  contactInfo.push(currentContactInfo);
});
...
zooAnimals.forEach(function(zooAnimals) {
  ...
  let zooAnimalNames=zooAnimals.animal_name + ' ' + zooAnimals.scientific_name;
  animalNames.push(zooAnimalNames);
});
...
const lowerCase = zooAnimals.map(function(nowLowerCase) { 
  return nowLowerCase.animal_name.toLowerCase()});
